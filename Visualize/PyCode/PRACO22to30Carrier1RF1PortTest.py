...
saveFile = 'PRACO22to30s2_Carrier1Test_29.5to30.5GHz_Branch2'
headerString = 'Branch 2 Out on Port A\n'
headerString = headerString + ' ,PS00,PS10,PS01,PS11'
#==============================================================================
if __name__ == '__main__':
    ...
    #### Plot Data ####   
    plt.plot(freq,data[:,1],'r',freq,data[:,2],'b',freq,data[:,3],'k',freq,data[:,4],'g')    
...
#    plt.legend('Port A','Port B','Port R')
    ...
    board.exit()
    #### Save Data ####
    headerString = headerString + '\nfreq(GHz),PA(dBm),PA(dBm),PA(dBm),PA(dBm)'#,PB(dBm),PR(dBm)'   
