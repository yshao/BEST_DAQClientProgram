...
def update_sensor_init(db):
    rechash={}

    rechash.update({"c1_c1":300, "c1_c2":300, "c1_c3":300, "c1_c4":300, "c1_c5":300, "c1_c6":300,
                    "c2_c1":300, "c2_c2":300, "c2_c3":300, "c2_c4":300, "c2_c5":300, "c2_c6":300,
                    "c3_c1":300, "c3_c2":300, "c3_c3":300, "c3_c4":300, "c3_c5":300, "c3_c6":300,
                    "c4_c1":300, "c4_c2":300, "c4_c3":300, "c4_c4":300, "c4_c5":300, "c4_c6":300,
                    "c5_c1":300, "c5_c2":300, "c5_c3":300, "c5_c4":300, "c5_c5":300, "c5_c6":300,
                    "c6_c1":300, "c6_c2":300, "c6_c3":300, "c6_c4":300, "c6_c5":300, "c6_c6":300
                   })

    db.replace_dict("enc_init",rechash)
    db.commit()
    ...
    with open(file,'rb') as fh:
      ...
      while(1):
        ...
        try:
            ...
            # calib[2] = narray.average() #C3
            #
            # narray=db.get_data('select * from c1_a where c1_a != ""')
            # calib[3] = narray.average() #C4

            calib=db.select_data('select * from enc_init')
            # calib[0] = narray.average() #C1

            apply_pressure_conversion(rec[0],rec[20],calib)
            ...
            rechash2="select c1_a1,c2_a1,c3_a1,c1_a3,c2_a3,c3_a3"
            npr=MS5803_convert(rehash2,calib)
