...
class ClientCommand(object):
    ...
    def build_command(self,cmd,arg):
        cmd=self.__getattribute__(cmd)+arg


    def send_set_time(self):
        self.cmd=self.SEND_MOTOR+get_curr_time_hex()

    def send_motor_cmd(self):
        SEND_MOTOR+get_curr_time_hex()
