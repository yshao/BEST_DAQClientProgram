...
### ui files
from ui_motormonitorwidget import Ui_MotorMonitorWidget
...
class MotorMonitorWidget(QtGui.QWidget):
    ### connects widgets and signals ###
    def __init__(self, parent = None):
        super(MotorMonitorWidget, self).__init__(parent)
        self.ui = Ui_MotorMonitorWidget()
