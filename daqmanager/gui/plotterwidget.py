...
class PlotterWidget(QtGui.QWidget):
    ...
    def guiPlot(self):
        ...
        self.mpl.update_labels(self.ui.inTitle,self.ui.inXLabel,self.ui.inYLabel)
        task=PlotDataTask()
        task.start()


        # plotter=Plotter(dataR)
        # plotter.title(self.ui.inTitle)
        # plotter.ylabel(self.ui.inXLabel)
        # plotter.xlabel(self.ui.inYLabel)
        # plotter.show()
        # plotter.refresh()
        #
        #
