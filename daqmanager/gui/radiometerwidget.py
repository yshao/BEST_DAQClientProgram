...
### ui files
from ui_radiometerwidget import Ui_RadiometerWidget
...
class RadiometerWidget(QtGui.QWidget):
    ### connects widgets and signals ###
    def __init__(self, parent = None):
        super(RadiometerWidget, self).__init__(parent)
        self.ui = Ui_RadiometerWidget()
