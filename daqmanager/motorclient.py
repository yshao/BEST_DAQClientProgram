from best.common.netutils import TelnetClient
import math
...
class MotorClient(object):
  ...
  def __init__(self,mode,host_url,user,password):
      ""
      self.telnet=TelnetClient(host_url,user,password)
...
# import unittest
# import best.common.configutils
#
